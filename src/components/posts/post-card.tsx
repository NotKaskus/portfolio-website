...
function PostCard({ data, isNew }: CardOptions) {
  ...
  return (
    <Link
      ...
      rel="prefetch"
      className="flex group @container h-full transition-transform duration-300 transform-gpu rounded border bg-background w-full">
      <div className="flex flex-row flex-1 relative h-full">
        <div className="z-1 flex-1">
          <div className="flex flex-col gap-2 px-4 py-4">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 whitespace-normal leading-6">
              {data.description}
            </p>
            <time
